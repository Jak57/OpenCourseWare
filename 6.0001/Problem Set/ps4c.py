...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for i in range(len(VOWELS_LOWER)):
            ...
            vowel = VOWELS_LOWER[i]
            transpose_dict[vowel] = vowels_permutation[i].lower()
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        vowel_permutations_list = get_permutations(VOWELS_LOWER)
        word_list = self.get_valid_words()
        max_match = 0
        answer = ""
     
        for permutation in vowel_permutations_list:
            transpose_dict = self.build_transpose_dict(permutation)
           
            decrypted_message = self.apply_transpose(transpose_dict)
           
            
            possible_word_list = decrypted_message.split(" ")
